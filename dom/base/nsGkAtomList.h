...
GK_ATOM(any, "any")
GK_ATOM(any_hover, "any-hover")
GK_ATOM(any_pointer, "any-pointer")
...
GK_ATOM(HARD, "HARD")
GK_ATOM(hasSelectorDependency, "has-selector-dependency")
...
GK_ATOM(scrollbarwidth, "scrollbarwidth")
