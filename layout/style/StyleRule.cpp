...
public:
  ...
  virtual Declaration* GetCSSDeclaration(Operation aOperation) override;
  virtual nsresult SetCSSDeclaration(Declaration* aDecl) override;
...
nsresult
DOMCSSDeclarationImpl::SetCSSDeclaration(Declaration* aDecl)
{
